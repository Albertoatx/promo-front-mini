...
angular.module('promotorApp')
	.controller('PromotorDetailCtrl', 
	  ['$scope', '$log', 'promotoresFactory', '$routeParams', '$location', 'provinciasDataSvc', '$rootScope',
		function ($scope, $log, promotoresFactory, $routeParams, $location, provinciasDataSvc, $rootScope) {
			...
			/*
			$scope.googleUndefined = (window.google === undefined);
      
			if ($scope.googleUndefined) {
				$scope.googleUrl = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyAYPE5eUENmWQ4ci3EkbTBR3C1c45qb9tA';
			} else {
				$scope.googleUrl = '..';
			}
			console.log('$scope.googleUndefined = ' + $scope.googleUndefined);
			...
			*/
			...
			$scope.googleHref = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyAYPE5eUENmWQ4ci3EkbTBR3C1c45qb9tA';

			if ($scope.googleUndefined) //if true
				$rootScope.loadScript($scope.googleHref, 'text/javascript'); 
			//------------------------------------------------------------------------
